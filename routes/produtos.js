...
router.get('/editar/:id', function(req, res) {
  ...
  pool.connect(function(err, client,done){
  client.query('SELECT prod.idproduto as idproduto,prod.descricao as descricao,prod.precocusto as precocusto, prod.precorevenda as precorevenda, prod.precocliente as precocliente FROM produto as prod WHEN idproduto = $1;',[id],function(err, result){
    done();
    if(err){
      console.log(err.stack)
  }
